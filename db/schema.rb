...
ActiveRecord::Schema[7.0].define(version: 20_221_205_184_225) do
  ...
  create_table 'accessions', force: :cascade do |t|
    ...
    t.index %w[population_id accession_number], name: 'index_accessions_on_population_id_and_accession_number', unique: true
  ...
  create_table 'populations', force: :cascade do |t|
    ...
    t.index %w[population_name subpopulation], name: 'index_populations_on_population_name_and_subpopulation', unique: true
  end
  ...
  create_table 'seeds', force: :cascade do |t|
    ...
    t.index %w[species_id generation accession_id], name: 'uniqueness_index', unique: true
  ...
  create_table 'seeds_plant_samples', force: :cascade do |t|
    ...
    t.index %w[seed_id plant_sample_id], name: 'index_seeds_plant_samples_on_seed_id_and_plant_sample_id', unique: true
  ...
  create_table 'species', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[genus species], name: 'index_species_on_genus_and_species', unique: true
  end
  ...
  create_table 'tubes', force: :cascade do |t|
    ...
    t.index %w[seedbox_id position], name: 'index_tubes_on_seedbox_id_and_position', unique: true
