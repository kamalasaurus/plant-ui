...
ActiveRecord::Schema[7.0].define(version: 20_220_824_171_828) do
  ...
  create_table 'populations', force: :cascade do |t|
    ...
    t.index %w[name subpopulation], name: 'index_populations_on_name_and_subpopulation', unique: true
  end
  ...
  create_table 'seeds', force: :cascade do |t|
    ...
    t.index %w[species generation accession population_id], name: 'uniqueness_index', unique: true
  end
