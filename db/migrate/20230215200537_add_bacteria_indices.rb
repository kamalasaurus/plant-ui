class AddBacteriaIndices < ActiveRecord::Migration[7.0]
  def change
    ...
    add_index :bacteria_locations, %i[bacteria_population_id latitude longitude], name: 'uniqueness_index', unique: true
    add_index :bacteria_accessions, %i[bacteria_population_id sample_identity], name: 'uniqueness_index', unique: true
