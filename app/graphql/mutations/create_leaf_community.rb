  ...
  class CreateLeafCommunity < BaseMutation
    ...
    def resolve(
      ...
      LeafCommunity.create!(
        ...
        leaf_otu_246:,
        leaf_otu_365:,
        leaf_microbiota_richness:,
        leaf_microbiota_shannon:,
        leaf_microbiota_pcoa1:,
        leaf_microbiota_pcoa2:,
        leaf_pathobiota_richness:,
        leaf_pathobiota_shannon:,
        leaf_pathobiota_pcoa1:,
        leaf_pathobiota_pcoa2:
      )
    end
  end
end
