...
class BinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bin" do
    assert_difference("Bin.count") do
      post bins_url, params: { bin: { location: @bin.location, quantity: @bin.quantity, seed_id: @bin.seed_id, seedbox: @bin.seedbox } }
    end
  ...
  test "should update bin" do
    patch bin_url(@bin), params: { bin: { location: @bin.location, quantity: @bin.quantity, seed_id: @bin.seed_id, seedbox: @bin.seedbox } }
