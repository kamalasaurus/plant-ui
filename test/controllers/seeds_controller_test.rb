...
class SeedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seed" do
    assert_difference("Seed.count") do
      post seeds_url, params: { seed: { generation: @seed.generation, location: @seed.location, quantity: @seed.quantity, seedbox: @seed.seedbox, species: @seed.species } }
    end
  ...
  test "should update seed" do
    patch seed_url(@seed), params: { seed: { generation: @seed.generation, location: @seed.location, quantity: @seed.quantity, seedbox: @seed.seedbox, species: @seed.species } }
